<template>
  <div class="dashboard-cascader">
    <ec-normal-cascader
      :props-config="normalCascaderConfig"
      :props-options="normalCascaderOptions"
      :props-data.sync="normalCascaderPropsData"
      :props-caption-data.sync="normalCascaderPropsCaptionData">
    </ec-normal-cascader>
  </div>
</template>
<script>
