<template>
  <div class="ec-login" id="login">
    <el-form class="ec-loginForm" :model="loginForm" :rules="loginRules" ref="loginForm">
      <el-form-item class="ec-loginForm-item">
        <h4 class="ec-loginForm-title">
          测试管理后台
        </h4>
      </el-form-item>
      <el-form-item class="ec-loginForm-item" prop="account">
      ...
      <el-form-item class="ec-loginForm-item" prop="password">
        <el-input type="password" placeholder="请输入密码" v-model="loginForm.password">
          <i slot="prefix" class="el-input__icon fa fa-lock" aria-hidden="true"></i>
        </el-input>
      </el-form-item>
      <el-form-item class="ec-loginForm-item">
        <el-button class="ec-loginForm-loginBtn" type="primary" @click="login">登陆</el-button>
